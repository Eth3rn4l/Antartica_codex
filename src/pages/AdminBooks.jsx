            ...
            <li key={b.id} style={{ marginBottom: '0.5rem' }}>
              ...
              {editingId === b.id ? (
                <span style={{ marginLeft: 12 }}>
                  ...
                  <button onClick={() => saveEdit(b.id)} style={{ marginLeft: 8 }}>Guardar</button>
                  <button onClick={cancelEdit} style={{ marginLeft: 8 }}>Cancelar</button>
                </span>
              ) : (
                <span>
                  <button onClick={() => startEdit(b)} style={{ marginLeft: '0.5rem' }}>Editar stock</button>
                  <button onClick={() => removeBook(b.id)} style={{ marginLeft: '0.5rem', backgroundColor: '#ff4d4d', border: 'none', borderRadius: '6px', padding: '0.3rem 0.6rem', color: 'white', cursor: 'pointer' }}>Eliminar</button>
                </span>
              )}
            </li>
          ))}
