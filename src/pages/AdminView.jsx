      ...
      <div style={{ ...cardStyle, margin: '0 auto', maxWidth: 900, padding: '2.5rem' }}>
        ...
        <div style={contentStyle}>
          ...
          <div style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem' }}>
            <button onClick={() => window.location.href = '/admin/books'} style={{ padding: '0.8rem 1.2rem', fontWeight: 600 }}>Controles de libros</button>
            <button onClick={() => window.location.href = '/admin/users'} style={{ padding: '0.8rem 1.2rem', fontWeight: 600 }}>Gestión de usuarios</button>
          </div>

          {/* Información del admin debajo de las opciones */}
          <div style={{ marginTop: '1.75rem', padding: '1rem', borderRadius: 8, background: '#e6f7f7', border: '1px solid #cfecee' }}>
