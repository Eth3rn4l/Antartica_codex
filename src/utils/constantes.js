 ...
 * Define usuarios con permisos administrativos
 */
export const ADMIN_CONFIG = {
  ...
  // Permisos por rol
  PERMISSIONS: {
    admin: ['read', 'write', 'delete', 'manage_users', 'manage_stock'],
    client: ['read', 'purchase']
  }
};
...
export const ADMIN_DASHBOARD = {
  ...
  PRODUCT_FIELDS: [
    'title', 'author', 'category', 'price', 'stock', 'description', 'image'
  ]
};
